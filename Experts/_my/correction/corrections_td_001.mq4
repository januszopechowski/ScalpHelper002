...
int  nElems=30;
ScalpTradeOpener001* toColl[];
TradeOpenInfo* tiCol[];
PriceScalpOpenCheck *ocCol[];
PriceScalpMissCheck *mcCol[];



//int n = 4;
//double _tlevel[]; 
//TradeSide    _tlevel_side1[];
...
class PriceLevelFinder
{

   bool _isThereALevelPrice;
   double _price;
   ...
   bool IsThereALevelPrice()
   {
      return _isThereALevelPrice;      
   }   
}

double GetLevelPrice()
   {
      double data1 =0;
      IsTherePriceLevel* p = new IsTherePriceLevel
 ...
 PriceLevelFinder *_priceLevelFinder;
...
int OnInit()
  {
   ...
   _priceLevelFinder = new PriceLevelFinder();
...
//---
 ...
 _takeSunday, 
  ...
  _signal2 = new HighCandlesFilter(_symbol,_period,0.0,_checkPriceSpeedMaxDistanceInPips,_checkPriceSpeedWindowInMinutes,_signal1);
      ...
      ArrayResize(toColl,nElems);
      ArrayResize(tiCol,nElems);
      ArrayResize(ocCol,nElems);
      ArrayResize(mcCol,nElems);
